...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s udoncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  udoncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded udoncoin transaction") + "\n" +
              "  udoncoin-tx [options] -create [commands]   " + _("Create hex-encoded udoncoin transaction") + "\n" +
              "\n";
